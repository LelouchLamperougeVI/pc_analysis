...
for i=1:shuffles % NB randomize for more sequences
    shuffled_scores(i)=needleWunsch(sequences{1}(randperm(length(sequences{1}))),sequences{1}(randperm(length(sequences{1}))));
end
